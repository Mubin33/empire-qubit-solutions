...
const MetricCounter = () => {
    const metrics = [
        ...
        { label: "Country Network", value: 80, suffix: "+" },
        { label: "Client Served", value: 40000, suffix: "+" },
        { label: "Projects Delivered", value: 85000, suffix: "+" },
    ];
    ...
    return (
        <section className="py-20 bg-[#77c2ff] text-white relative overflow-hidden">
            ...
            <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5 gap-8 text-center divide-x divide-slate-400/50">
